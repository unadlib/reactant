...
- [ReactModuleOptions](reactant_ssr.md#reactmoduleoptions)
...
- [perform](reactant_ssr.md#perform)
...
Ƭ **Load**: (`service`: [`ThisService`](reactant_ssr.md#thisservice), `loadModules`: [`ReactModuleOptions`](reactant_ssr.md#reactmoduleoptions)[]) => `Promise`<[`Container`](reactant_ssr.md#container)\>
...
| `loadModules` | [`ReactModuleOptions`](reactant_ssr.md#reactmoduleoptions)[] |
...
Ƭ **Loader**: (`loadModules`: [`ReactModuleOptions`](reactant_ssr.md#reactmoduleoptions)[], `beforeReplaceReducer?`: (`container`: [`Container`](reactant_ssr.md#container)) => `void`) => `void`
...
Ƭ **ReactModuleOptions**<`T`\>: [`ModuleOptions`](reactant_ssr.md#moduleoptions)<`T`\>
...
Ƭ **Watch**: <P, T\>(`service`: [`ThisService`](reactant_ssr.md#thisservice), `selector`: `Selector`<`P` extends ``true`` ? [...T] : `T`\>, `watcher`: `Watcher`<`T`\>, `options?`: { `isEqual?`: (`x`: `unknown`, `y`: `unknown`) => `boolean` ; `multiple?`: `P`  }) => `Unsubscribe`
...
| :------ | :------ |
| `container` | `Container` |
| `modules` | [`ModuleOptions`](reactant_ssr.md#moduleoptions)<`any`\>[] |
...
▸ **computed**(`depsCallback`): (`target`: `object`, `key`: `string`, `descriptor`: `TypedPropertyDescriptor`<`any`\>) => { `get`: (`this`: [`Service`](../interfaces/reactant_ssr.Service.md)<`Record`<`string`, `any`\>\>) => `any`  }
...
| Name | Type |
| :------ | :------ |
| `get` | (`this`: [`Service`](../interfaces/reactant_ssr.Service.md)<`Record`<`string`, `any`\>\>) => `any` |
...
▸ **createApp**<`T`, `S`, `R`\>(`__namedParameters`): [`App`](../interfaces/reactant_ssr.App.md)<`T`, `S`, `R`\>
...
| Name | Type |
| :------ | :------ |
| `__namedParameters` | [`Config`](../interfaces/reactant_ssr.Config.md)<`T`, `S`, `R`\> |
...
[packages/reactant-ssr/src/createServerApp.tsx:10](https://github.com/unadlib/reactant/blob/46d47605/packages/reactant-ssr/src/createServerApp.tsx#L10)
...
▸ **createStore**<`T`\>(`__namedParameters`): [`ReactantStore`](reactant_ssr.md#reactantstore)
...
| :------ | :------ |
| `service` | [`ThisService`](reactant_ssr.md#thisservice) |
| `loadModules` | [`ReactModuleOptions`](reactant_ssr.md#reactmoduleoptions)<`any`\>[] |
