...
*Defined in [packages/reactant-di/src/decorators/inject.ts:11](https://github.com/unadlib/reactant/blob/7dec51d/packages/reactant-di/src/decorators/inject.ts#L11)*
