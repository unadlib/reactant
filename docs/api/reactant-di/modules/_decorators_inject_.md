...
*Defined in [packages/reactant-di/src/decorators/inject.ts:51](https://github.com/unadlib/reactant/blob/5a9891fd/packages/reactant-di/src/decorators/inject.ts#L51)*
