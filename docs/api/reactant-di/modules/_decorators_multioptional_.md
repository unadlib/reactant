...
*Defined in [packages/reactant-di/src/decorators/multiOptional.ts:7](https://github.com/unadlib/reactant/blob/f1370319/packages/reactant-di/src/decorators/multiOptional.ts#L7)*
