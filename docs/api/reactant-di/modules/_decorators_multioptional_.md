...
*Defined in [packages/reactant-di/src/decorators/multiOptional.ts:7](https://github.com/unadlib/reactant/blob/9a189fb/packages/reactant-di/src/decorators/multiOptional.ts#L7)*
