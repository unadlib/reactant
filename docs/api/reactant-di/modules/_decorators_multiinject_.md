...
*Defined in [packages/reactant-di/src/decorators/multiInject.ts:4](https://github.com/unadlib/reactant/blob/40f38c4/packages/reactant-di/src/decorators/multiInject.ts#L4)*
