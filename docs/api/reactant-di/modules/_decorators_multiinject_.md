...
*Defined in [packages/reactant-di/src/decorators/multiInject.ts:4](https://github.com/unadlib/reactant/blob/f1370319/packages/reactant-di/src/decorators/multiInject.ts#L4)*
