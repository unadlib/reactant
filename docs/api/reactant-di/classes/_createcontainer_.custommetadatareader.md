...
*Defined in [packages/reactant-di/src/createContainer.ts:73](https://github.com/unadlib/reactant/blob/72dc788/packages/reactant-di/src/createContainer.ts#L73)*
