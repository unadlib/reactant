...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/7dec51d/packages/reactant-di/src/createContainer.ts#L25)*
