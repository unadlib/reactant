...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/5a9891fd/packages/reactant-di/src/createContainer.ts#L25)*
