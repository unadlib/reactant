...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/f1370319/packages/reactant-di/src/createContainer.ts#L25)*
