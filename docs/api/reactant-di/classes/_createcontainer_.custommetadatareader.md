...
*Defined in [packages/reactant-di/src/createContainer.ts:73](https://github.com/unadlib/reactant/blob/8c9cd62/packages/reactant-di/src/createContainer.ts#L73)*
