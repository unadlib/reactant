...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/03d0c8fd/packages/reactant-di/src/createContainer.ts#L25)*
