...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/52f575c/packages/reactant-di/src/createContainer.ts#L25)*
