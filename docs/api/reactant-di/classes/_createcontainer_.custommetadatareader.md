...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/1f3f457d/packages/reactant-di/src/createContainer.ts#L25)*
