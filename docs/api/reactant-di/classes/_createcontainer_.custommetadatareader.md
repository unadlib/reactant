...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/f8f02435/packages/reactant-di/src/createContainer.ts#L25)*
