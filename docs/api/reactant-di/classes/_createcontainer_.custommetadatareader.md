...
*Defined in [packages/reactant-di/src/createContainer.ts:73](https://github.com/unadlib/reactant/blob/31e722a/packages/reactant-di/src/createContainer.ts#L73)*
