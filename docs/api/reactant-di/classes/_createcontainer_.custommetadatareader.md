...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/a4942f1/packages/reactant-di/src/createContainer.ts#L25)*
