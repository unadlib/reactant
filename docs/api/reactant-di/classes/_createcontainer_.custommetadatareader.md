...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/3c42723/packages/reactant-di/src/createContainer.ts#L25)*
