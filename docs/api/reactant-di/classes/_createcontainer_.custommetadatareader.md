...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/84acaf3/packages/reactant-di/src/createContainer.ts#L25)*
