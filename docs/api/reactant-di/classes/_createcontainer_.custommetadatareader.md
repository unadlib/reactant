...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/40f38c4/packages/reactant-di/src/createContainer.ts#L25)*
