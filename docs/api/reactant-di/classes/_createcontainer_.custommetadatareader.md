...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/a019d587/packages/reactant-di/src/createContainer.ts#L25)*
