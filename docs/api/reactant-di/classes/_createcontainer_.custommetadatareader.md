...
*Defined in [packages/reactant-di/src/createContainer.ts:25](https://github.com/unadlib/reactant/blob/9a189fb/packages/reactant-di/src/createContainer.ts#L25)*
