...
▸ `Const` **createServerApp**<`T`, `S`, `R`\>(`options`): `ServerApp`<`T`, `S`, `R`\>
...
[packages/reactant-ssr/src/createServerApp.tsx:10](https://github.com/unadlib/reactant/blob/3696addb/packages/reactant-ssr/src/createServerApp.tsx#L10)
