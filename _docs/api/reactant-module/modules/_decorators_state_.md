[reactant-module](../README.md) › [Globals](../globals.md) › ["decorators/state"](_decorators_state_.md)
...
*Defined in [packages/reactant-module/src/decorators/state.ts:4](https://github.com/unadlib/reactant/blob/222a645/packages/reactant-module/src/decorators/state.ts#L4)*
